...
const FirstVue = ({
    ...
    const pages=[  <View style={tw`h-full w-full bg-black`}>
    <ImageBackground style={tw`w-full h-full `} source={require("../../assets/images/coachbg.png")}>
        <View style={{ width: "100%", height: "100%", backgroundColor: "transparent" }}>
            ...
            <View style={tw`bg-black opacity-80 `}>
                <View style={tw`bg-transparent text-left items-center`}>
                    <Text style={{backgroundColor: "transparent",color:"white",alignItems:"center",marginLeft:"5%",fontSize:30,fontWeight:"500"}}>Exercise Daily </Text >
                </View>
...
<ImageBackground style={tw`w-full h-full `} source={require("../../assets/images/back.jpg")}>
    <View style={{ width: "100%", height: "100%", backgroundColor: "transparent" }}>
        ...
        <View style={tw`bg-black opacity-80 `}>
            <View style={tw`bg-transparent text-left items-center`}>
                <Text style={{backgroundColor: "transparent",color:"white",alignItems:"center",marginLeft:"5%",fontSize:30,fontWeight:"500"}}> Stay Motivated </Text >
            </View>
            {/* {tw`font-bold text-white bg-transparent text-3xl` */}
            <View style={{ backgroundColor: "transparent", height: "25%", width: "90%", alignItems: "center",marginLeft:"5%"}}>
                <Text style={tw`text-white `} >Stop wishing, Start doing, Join our community </Text>
   ...
   const [page,setPage]:any=useState(pages[0])
