...
<Text style = {tw`font-bold  bg-transparent text-3xl`}> {ready[0]}  </Text > 
</View>

<View  style ={{backgroundColor : "transparent",height :"12%" ,width:"90%", alignItems: "center"}}>
    <Text  >{ready[1].slice(0,150)}...  </Text>
    </View>
    </View>
