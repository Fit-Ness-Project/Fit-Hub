        ...
        <View style={{ marginTop: 10, marginBottom: 60 }}>
          <View style={tw`h-52 p-2 bg-white pl-4 pr-4`}>
            <TouchableOpacity onPress={() => navigation.navigate("Gyms")}>
              ...
              >
                <View
                  style={tw`bg-transparent h-20 absolute inset-x-0 bottom-16  w-full`}
                >
                  <View style={styles.view}>
                    <View style={styles.inview}>
                      ...
                      <View style={tw`h-10 items-center bg-transparent pt-1 `}>
                        <Text style={tw`text-white text-3xl pl-2 font-bold`}>
                          GYMS
                        </Text>
                      </View>
                    </View>
          ...
          <View style={tw`h-52 p-2 bg-white pl-4 pr-4 `}>
            <TouchableOpacity onPress={() => navigation.navigate("Restaurant")}>
              <ImageBackground
                style={{ width: "100%", height: "100%" }}
                source={require("../../../../assets/images/resto3.png")}
              >
                <View
                  style={tw`bg-transparent h-20 absolute inset-x-0 bottom-16  w-full`}
                >
          ...
          <View style={tw`h-52 p-2 bg-white pl-4 pr-4 `}>
            <TouchableOpacity onPress={() => navigation.navigate("Events")}>
              <ImageBackground
                style={{ width: "100%", height: "100%" }}
                source={require("../../../../assets/images/events3.png")}
              >
                <View
                  style={tw`bg-transparent h-20 absolute inset-x-0 bottom-16  w-full`}
                >
          ...
          <View style={tw`h-52 p-2 bg-white pl-4 pr-4 `}>
            <TouchableOpacity onPress={() => navigation.navigate("Blogs")}>
              <ImageBackground
                style={{ width: "100%", height: "100%" }}
                source={require("../../../../assets/images/blog5.png")}
              >
                <View
                  style={tw`bg-transparent h-20 absolute inset-x-0 bottom-16  w-full`}
                >
